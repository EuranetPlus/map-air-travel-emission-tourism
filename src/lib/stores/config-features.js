export const config = {
	mapTitle: 'air-travel-emissio-tourism', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-air-travel-emission-tourism.vercel.app/', // The url provided when deploying the map on Vercel
